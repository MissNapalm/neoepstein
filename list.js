...
const graphData = {
    nodes: [
        ...
        {id:"epstein",label:"Jeffrey Epstein",type:"center",radius:32,
            ...
            intelRole:"Convicted sex offender and suspected intelligence asset who ran a multi-decade sexual blackmail operation. Former US Attorney Alexander Acosta told the Trump transition team Epstein 'belonged to intelligence' and to 'leave it alone.' Properties contained hidden cameras. His wealth had no traceable legitimate origin.",
       ...
       {id:"kellen",label:"Sarah Kellen",type:"center",radius:22,
        ...
        {id:"casablancas",label:"John Casablancas",type:"suspicious",radius:15,
         ...
         {id:"wexner",label:"Les Wexner",type:"center",radius:30,
            agency:"L BRANDS / THE LIMITED / MEGA GROUP",role:"Billionaire Retailer · Mega Group Co-Founder · Sole Known Client",status:"NAMED IN FILES — never investigated",networth:"$5.3B",
            intelRole:"Financial origin of the Epstein operation. Gave a college dropout power of attorney over ~$1.4B and a $77M townhouse for $0. Co-founded the Mega Group with Bronfman the same year — a secretive billionaire organization with documented Israeli intelligence ties.",
            epsteinLink:"1991 power of attorney. $77M townhouse for $0. Victoria's Secret weaponized as recruitment lure. Wexner Foundation paid Ehud Barak $2.3M. Maria Farmer assaulted at Wexner's Ohio compound in 1996. FBI took no action for twelve years.",
            significance:"No legitimate explanation exists for why a self-made billionaire gave everything to a man with no credentials. No forensic audit. No deposition. No congressional hearing. The most protected person in this story.",
            desc:"In 1991, Les Wexner — the most methodical billionaire in American retail — gave a college dropout with no degree, no license, and no traceable clients complete power of attorney over his finances. That same year he transferred a $77M Manhattan townhouse to Epstein for zero dollars. That house became the operational headquarters of a global sex trafficking and blackmail operation, wired with hidden cameras.\n\nThat same year, 1991, Wexner co-founded the Mega Group with Charles Bronfman — a secretive organization of the wealthiest Jewish-American businessmen with documented Israeli intelligence ties.\n\nVictoria's Secret was weaponized as a recruitment tool. Alicia Arden filed a police report in 1997 after Epstein groped her during what she thought was a casting call. Maria Farmer — the first person to report Epstein to the FBI — was assaulted at Wexner's personal Ohio compound. The FBI did nothing for twelve years.\n\nThe Wexner Foundation paid former Israeli PM Ehud Barak $2.3M. Barak visited Epstein's townhouse 36+ times and co-invested with Epstein in Carbyne911 surveillance tech. Money flowed from Wexner through Epstein to the former head of Israeli military intelligence.\n\nAfter 2019, Wexner claimed Epstein 'misappropriated vast sums.' He didn't say how much. He didn't file a police report. He didn't sue. He didn't request an audit. That is not the behavior of a man who has been robbed. That is the behavior of a man who does not want the books opened.\n\nNo forensic accounting has ever been conducted. No subpoena issued. No grand jury convened. No congressional committee has called him to testify.",
            evidence:"Power of attorney document (1991). Deed transfer of $77M townhouse for $0. Mega Group co-founding with Bronfman (1991). Wexner Foundation $2.3M payment to Barak. Victoria's Secret recruitment complaints (Alicia Arden police report 1997). Maria Farmer assault at Wexner Ohio compound (1996 FBI report). FBI inaction 12+ years. Hidden cameras documented. Post-arrest 'misappropriation' claim with no evidence or civil suit. No forensic audit. No deposition. Ben-Menashe account. Flight logs. Black book.",
            link:"He gave a nobody a $77M house and control of $1.4 billion. The house became trafficking HQ. The first victim was assaulted on his property. His foundation paid millions to a man who visited the trafficking house 36 times. He said he was robbed and never filed a charge. No one has compelled him to answer a question under oath."},
        ...
        {id:"acosta",label:"Alexander Acosta",type:"center",radius:17,
            ...
            intelRole:"As US Attorney for Southern District of Florida, signed the 2008 Non-Prosecution Agreement that gave Epstein a 13-month county jail sentence with work release and immunized all co-conspirators. Later told the Trump transition team that Epstein 'belonged to intelligence' and to 'leave it alone.' Appointed Labor Secretary by Trump despite his role in the NPA.",
            epsteinLink:"Signed the NPA. Told Trump transition team Epstein 'belonged to intelligence.' Appointed Labor Secretary. Resigned July 2019 after Epstein re-arrest.",
            significance:"Acosta's 'belonged to intelligence' statement is the closest any US official has come to confirming Epstein was a protected intelligence asset. He was rewarded with a cabinet position.",
            desc:"Alexander Acosta served as US Attorney for the Southern District of Florida when his office negotiated the 2008 Non-Prosecution Agreement with Epstein's defense team. The NPA gave Epstein a 13-month county jail sentence with 12 hours/day work release, required registration as a sex offender, and — critically — granted immunity to all named and unnamed co-conspirators. The deal was later ruled to have violated the Crime Victims' Rights Act because victims were not notified. During the Trump transition, Acosta reportedly told the vetting team that he had been told Epstein 'belonged to intelligence' and to 'leave it alone.' Trump appointed Acosta as Secretary of Labor in 2017. Acosta resigned in July 2019 after Epstein's re-arrest brought renewed scrutiny to the NPA.",
            evidence:"NPA document signed by Acosta. 'Belonged to intelligence' statement reported by Vicky Ward. Crime Victims' Rights Act violation ruling by Judge Marra. Resigned July 2019. Trump appointment despite NPA role.",
            link:"The prosecutor said Epstein 'belonged to intelligence' and was told to back off. Then he signed the deal that freed everyone. Then he got a cabinet position."},
        ...
        {id:"blair",label:"Tony Blair",type:"suspicious",radius:28,
            agency:"UK GOVERNMENT",role:"Former UK Prime Minister",status:"NAMED IN FILES",
            desc:"Met with Epstein after conviction. Named in contact files.",evidence:"Named in contact files. Post-conviction meetings.",
            link:"Another head of government in the contact book."},

        {id:"mandelson",label:"Peter Mandelson",type:"suspicious",radius:20,
            agency:"UK GOVERNMENT",role:"Former Cabinet Minister · EU Commissioner",status:"NAMED IN FILES",
            desc:"Photographed with Epstein. Visited Epstein's island per flight logs.",
            evidence:"Photographed. Flight logs. Island visit.",
            link:"Senior UK political figure with documented island visits."},
        ...
        {id:"ferguson",label:"Sarah Ferguson",type:"suspicious",radius:18,
            ...
            desc:"Accepted £15,000 from Epstein funneled through Prince Andrew after conviction.",
            evidence:"£15K payment documented post-conviction.",
            link:"Royalty accepting money from a convicted sex offender."},
        ...
        {id:"olmert",label:"Ehud Olmert",type:"suspicious",radius:20,
            ...
            desc:"Israeli PM 2006-2009. Wexner/Mega Group connections. In office during Epstein's 2008 NPA.",
