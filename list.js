      ...
      link:"He emailed to get to the island. They arranged a massage. He bought the platform and let the child abuse material flood in. The richest man in the world, connected to both the production and distribution side of the same crime."
        ...
        {id:"hoffman",label:"Reid Hoffman",type:"suspicious",radius:18,
         ...
         {id:"thiel",label:"Peter Thiel",type:"suspicious",radius:24,
            agency:"PALANTIR / FOUNDERS FUND",role:"Tech Billionaire · CIA-Linked · Surveillance Infrastructure",status:"NAMED IN FILES",networth:"$9.4B",
            intelRole:"Co-founded Palantir Technologies with CIA seed funding through In-Q-Tel — the agency's venture capital arm. Palantir's surveillance software is used by the CIA, NSA, FBI, IDF, and Israeli intelligence services. Ehud Barak — former Israeli PM, former head of Aman (military intelligence), and documented Epstein associate who visited Epstein's townhouse 36+ times — was a co-investor with Thiel and Epstein in Carbyne911, a surveillance technology startup. This places Thiel at the intersection of American intelligence funding, Israeli military intelligence, and Epstein's financial network. Palantir's co-founder Alex Karp has deep ties to Israel and the company has contracts with the Israeli security state. Thiel was also the earliest major investor in Facebook, where he placed himself on the board of what became the world's largest personal data collection platform.",
            epsteinLink:"Named in Epstein files. Co-investment network with Ehud Barak through Carbyne911 — the same Barak who visited Epstein's townhouse 36+ times, received $2.3M from the Wexner Foundation and $5M from an Epstein-linked fund, and was named by Virginia Giuffre. Thiel's Palantir was funded by the CIA. Barak's Carbyne911 was funded by Epstein. Both are surveillance technology companies. The Thiel-Barak investment overlap connects CIA-funded surveillance infrastructure directly to Israeli military intelligence and Epstein's money. Thiel was a major Trump donor and transition team member — the same transition team where Acosta explained he had been told Epstein 'belonged to intelligence.'",
            significance:"Thiel sits at the exact convergence point of every axis in the Epstein network: American intelligence (CIA/In-Q-Tel → Palantir), Israeli intelligence (Barak → Carbyne911 → IDF/Mossad), surveillance technology (Palantir + Carbyne911), Silicon Valley data infrastructure (Facebook board), political power (Trump mega-donor and transition team), and Epstein's financial web. He is not in the contact book by accident. He is the node where the surveillance state, the intelligence state, and the Epstein network become architecturally indistinguishable.",
            desc:"Peter Thiel is a German-American billionaire who co-founded PayPal, was the first outside investor in Facebook (where he served on the board for nearly two decades), and co-founded Palantir Technologies with direct CIA seed funding through In-Q-Tel. Palantir builds surveillance and data analysis software used by the CIA, NSA, FBI, ICE, and military and intelligence services worldwide — including Israeli security services and the IDF.\n\nHe is named in Epstein's files. His investment network overlaps with Ehud Barak's through Carbyne911 — the surveillance startup co-funded by Epstein that provides emergency call-handling technology with real-time location tracking. Barak visited Epstein's Manhattan townhouse at least 36 times, received millions from Epstein-linked entities, and was named by Virginia Giuffre. The Thiel-Barak nexus connects two surveillance technology ecosystems — one funded by the CIA, one funded by a sex trafficker with Israeli intelligence ties — through shared Israeli military intelligence connections.\n\nThiel was a major donor to Donald Trump's 2016 campaign and served on the presidential transition team — the same team that vetted Alexander Acosta, who explained during that vetting that he had been told Epstein 'belonged to intelligence' and to 'leave it alone.' Thiel's protégés populated key positions in the Trump administration and the tech-adjacent policy world.\n\nHis Founders Fund and affiliated vehicles have invested across the national security technology landscape, creating a private intelligence-industrial complex that mirrors and often serves the state intelligence apparatus. The boundary between Thiel's commercial surveillance empire and state intelligence operations is not blurred — it is nonexistent.",
            evidence:"Named in Epstein files. Palantir co-founded with CIA/In-Q-Tel seed funding — documented. Barak co-investment overlap through Carbyne911 — Epstein funding documented, Barak involvement documented. Facebook board seat (2004–2022). Trump mega-donor and transition team member — transition team where Acosta explained he had been told Epstein 'belonged to intelligence.' Palantir contracts with Israeli security services. Founders Fund national security portfolio.",
            link:"CIA money built his surveillance company. Epstein money built Barak's surveillance company. They share an investment network. He sat on the board of the world's largest data collection platform. He funded the president whose team was told Epstein belonged to intelligence. Every wire crosses through Thiel."},
